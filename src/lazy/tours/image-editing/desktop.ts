...
import { observeClassAddedOnSelector, observeAttributeAdded, observeAttributeRemoved } from "../common";
...
export function saveStepDesktop(): TourStep {
    return {
        ...
        popover: {
            ...
            description: 'Click "Save" in the toolbar to publish your changes.',
            side: "top",
            align: "center",
        },
    };
